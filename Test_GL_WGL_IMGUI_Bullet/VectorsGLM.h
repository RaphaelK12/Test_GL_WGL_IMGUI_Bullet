...
typedef glm::tvec2<half, glm::lowp>  half2;
typedef glm::vec2     float2;
typedef glm::dvec2   double2;

typedef glm::u8vec2	   bvec2;
typedef glm::i8vec2   sbvec2;
...
//typedef glm::tvec2<glm::detail::hdata, glm::highp>  hvec2;
typedef glm::tvec2<half, glm::lowp>  hvec2;
...
typedef glm::tvec3<half, glm::lowp>  half3;
typedef glm::vec3     float3;
typedef glm::dvec3   double3;

typedef glm::u8vec3	   bvec3;
typedef glm::i8vec3   sbvec3;
...
//typedef glm::tvec3<glm::detail::hdata, glm::highp>  hvec3;
typedef glm::tvec3<half, glm::lowp>  hvec3;
...
typedef glm::tvec4<half, glm::lowp>  half4;
typedef glm::vec4     float4;
typedef glm::dvec4   double4;

typedef glm::u8vec4	   bvec4;
typedef glm::i8vec4   sbvec4;
...
//typedef glm::tvec4<glm::detail::hdata, glm::highp>  hvec4;
typedef glm::tvec4<half, glm::lowp>  hvec4;
